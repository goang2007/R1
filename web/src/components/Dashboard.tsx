      ...
      <main className="flex-1 px-6 py-7 sm:px-10">
        ...
        {tab === "settings" && (
          <div className="max-w-md">
            <h2 className="mb-4 text-lg font-bold text-ink">설정</h2>
            <div className="rounded-2xl border border-line p-5">
              <p className="text-sm text-muted">로그인 계정</p>
              <p className="mt-1 font-medium text-ink">{userEmail}</p>
              <button
                onClick={handleLogout}
                disabled={loggingOut}
                className="mt-4 rounded-xl border border-line px-4 py-2 text-sm font-semibold text-red transition-colors hover:bg-red-soft disabled:opacity-50"
              >
